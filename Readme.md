# 1DT106 Lecture 7: Optimization

This repository holds the slides for the seventh lecture in 1DT106 Programming
...
```bash 
git clone --recursive https://github.com/uu-1dt106/lecture7_optimization.git 
```
